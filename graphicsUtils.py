...
def keys_pressed(d_o_e=lambda arg: _root_window.dooneevent(arg), #tkinter._tkinter.dooneevent,
...
def remove_from_screen(x,
                       d_o_e=lambda arg: _root_window.dooneevent(arg), #tkinter._tkinter.dooneevent,
                       d_w=tkinter._tkinter.DONT_WAIT):
    _canvas.delete(x)
    d_o_e(d_w)
