...
class FixedRandom:
    def __init__(self):
        ...
        self.random = MyRandom() # Schrum: Change to use a difference definition of "choice"
        self.random.setstate(fixedState)

class MyRandom(random.Random):
    #Schrum: Had to override the "choice" definition for random generator because it changed from Python 2 to 3
    def choice(self, seq):
