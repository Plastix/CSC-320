...
class Actions:
    ...
    # _directionsAsList = _directions.items() Thank you Jacob Schrum:
    # Thiss needs to be hard coded to work with the autograder because
    # the order in which dictionary items are returns changed from
    # Python2 to Python 3
